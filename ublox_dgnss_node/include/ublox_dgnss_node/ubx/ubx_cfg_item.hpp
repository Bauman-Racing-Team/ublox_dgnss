...
// cfg uart1
const ubx_cfg_item_t CFG_UART1_ENABLED = {"CFG_UART1_ENABLED", 0x10520005, L, 1, NA};
const ubx_cfg_item_t CFG_UART1_BAUDRATE = {"CFG_UART1_BAUDRATE", 0x40520001, U4, 1, NA};
...
// cfg uart2
const ubx_cfg_item_t CFG_UART2_ENABLED = {"CFG_UART2_ENABLED", 0x10530005, L, 1, NA};
const ubx_cfg_item_t CFG_UART2_BAUDTATE = {"CFG_UART2_BAUDRATE", 0x40530001, U4, 1, NA};
...
// cfg i2c
const ubx_cfg_item_t CFG_I2C_ENABLED = {"CFG_I2C_ENABLED", 0x10510003, L, 1, NA};
...
// cfg msgout - other interfaces msg output rate configurations
const ubx_cfg_item_t CFG_MSGOUT_NMEA_ID_GGA_UART2 =
{"CFG_MSGOUT_NMEA_ID_GGA_UART2", 0x209100bc, U1, 0, NA};
const ubx_cfg_item_t CFG_MSGOUT_NMEA_ID_GLL_UART2 =
{"CFG_MSGOUT_NMEA_ID_GLL_UART2", 0x209100cb, U1, 0, NA};
const ubx_cfg_item_t CFG_MSGOUT_NMEA_ID_GSA_UART2 =
{"CFG_MSGOUT_NMEA_ID_GSA_UART2", 0x209100c1, U1, 0, NA};
const ubx_cfg_item_t CFG_MSGOUT_NMEA_ID_GSV_UART2 =
{"CFG_MSGOUT_NMEA_ID_GSV_UART2", 0x209100c6, U1, 0, NA};
const ubx_cfg_item_t CFG_MSGOUT_NMEA_ID_RMC_UART2 =
{"CFG_MSGOUT_NMEA_ID_RMC_UART2", 0x209100ad, U1, 0, NA};
const ubx_cfg_item_t CFG_MSGOUT_NMEA_ID_VTG_UART2 =
{"CFG_MSGOUT_NMEA_ID_VTG_UART2", 0x209100b2, U1, 0, NA};

const ubx_cfg_item_t CFG_MSGOUT_RTCM_3X_TYPE1074_UART1 =
{"CFG_MSGOUT_RTCM_3X_TYPE1074_UART1", 0x2091035f, U1, 0, NA};
const ubx_cfg_item_t CFG_MSGOUT_RTCM_3X_TYPE1084_UART1 =
{"CFG_MSGOUT_RTCM_3X_TYPE1084_UART1", 0x20910364, U1, 0, NA};
const ubx_cfg_item_t CFG_MSGOUT_RTCM_3X_TYPE1094_UART1 =
{"CFG_MSGOUT_RTCM_3X_TYPE1094_UART1", 0x20910369, U1, 0, NA};
const ubx_cfg_item_t CFG_MSGOUT_RTCM_3X_TYPE1124_UART1 =
{"CFG_MSGOUT_RTCM_3X_TYPE1124_UART1", 0x2091036e, U1, 0, NA};
const ubx_cfg_item_t CFG_MSGOUT_RTCM_3X_TYPE1230_UART1 =
{"CFG_MSGOUT_RTCM_3X_TYPE1230_UART1", 0x20910304, U1, 0, NA};
const ubx_cfg_item_t CFG_MSGOUT_RTCM_3X_TYPE4072_0_UART1 =
{"CFG_MSGOUT_RTCM_3X_TYPE4072_0_UART1", 0x209102ff, U1, 0, NA};

// cfg msgout - usb msg output rate configurations
...
// cfg timepulse
const ubx_cfg_item_t CFG_TP_PULSE_DEF = {"CFG_TP_PULSE_DEF", 0x20050023, E1, 1, NA};
const ubx_cfg_item_t CFG_TP_PULSE_LENGTH_DEF = {"CFG_TP_PULSE_LENGTH_DEF", 0x20050030, E1, 1, NA};
const ubx_cfg_item_t CFG_TP_PERIOD_TP1 = {"CFG_TP_PERIOD_TP1", 0x40050002, U4, 1e-6, S};
const ubx_cfg_item_t CFG_TP_PERIOD_LOCK_TP1 = {"CFG_TP_PERIOD_LOCK_TP1", 0x40050003, U4, 1e-6, S};
const ubx_cfg_item_t CFG_TP_LEN_TP1 = {"CFG_TP_LEN_TP1", 0x40050004, U4, 1e-6, S};
const ubx_cfg_item_t CFG_TP_LEN_LOCK_TP1 = {"CFG_TP_LEN_LOCK_TP1", 0x40050005, U4, 1e-6, S};
const ubx_cfg_item_t CFG_TP_USER_DELAY_TP1 = {"CFG_TP_USER_DELAY_TP1", 0x40050006, I4, 1e-9, S};
const ubx_cfg_item_t CFG_TP_TIMEGRID_TP1 = {"CFG_TP_TIMEGRID_TP1", 0x2005000c, E1, 1, NA};
const ubx_cfg_item_t CFG_TP_POL_TP1 = {"CFG_TP_POL_TP1", 0x1005000b, L, 1, NA};
...
std::map<ubx_key_id_t, ubx_cfg_item_t> ubxKeyCfgItemMap = {
  ...
  {CFG_UART1_ENABLED.ubx_key_id, CFG_UART1_ENABLED},
  {CFG_UART1_BAUDRATE.ubx_key_id, CFG_UART1_BAUDRATE},
  {CFG_UART2_ENABLED.ubx_key_id, CFG_UART2_ENABLED},
  {CFG_UART2_BAUDTATE.ubx_key_id, CFG_UART2_BAUDTATE},
  {CFG_I2C_ENABLED.ubx_key_id, CFG_I2C_ENABLED},
  ...
  {CFG_MSGOUT_NMEA_ID_GGA_UART2.ubx_key_id, CFG_MSGOUT_NMEA_ID_GGA_UART2},
  {CFG_MSGOUT_NMEA_ID_GLL_UART2.ubx_key_id, CFG_MSGOUT_NMEA_ID_GLL_UART2},
  {CFG_MSGOUT_NMEA_ID_GSA_UART2.ubx_key_id, CFG_MSGOUT_NMEA_ID_GSA_UART2},
  {CFG_MSGOUT_NMEA_ID_GSV_UART2.ubx_key_id, CFG_MSGOUT_NMEA_ID_GSV_UART2},
  {CFG_MSGOUT_NMEA_ID_RMC_UART2.ubx_key_id, CFG_MSGOUT_NMEA_ID_RMC_UART2},
  {CFG_MSGOUT_NMEA_ID_VTG_UART2.ubx_key_id, CFG_MSGOUT_NMEA_ID_VTG_UART2},

  {CFG_MSGOUT_RTCM_3X_TYPE1074_UART1.ubx_key_id, CFG_MSGOUT_RTCM_3X_TYPE1074_UART1},
  {CFG_MSGOUT_RTCM_3X_TYPE1084_UART1.ubx_key_id, CFG_MSGOUT_RTCM_3X_TYPE1084_UART1},
  {CFG_MSGOUT_RTCM_3X_TYPE1094_UART1.ubx_key_id, CFG_MSGOUT_RTCM_3X_TYPE1094_UART1},
  {CFG_MSGOUT_RTCM_3X_TYPE1124_UART1.ubx_key_id, CFG_MSGOUT_RTCM_3X_TYPE1124_UART1},
  {CFG_MSGOUT_RTCM_3X_TYPE1230_UART1.ubx_key_id, CFG_MSGOUT_RTCM_3X_TYPE1230_UART1},
  ...
  {CFG_TP_PULSE_DEF.ubx_key_id, CFG_TP_PULSE_DEF},
  {CFG_TP_PULSE_LENGTH_DEF.ubx_key_id, CFG_TP_PULSE_LENGTH_DEF},
  {CFG_TP_PERIOD_TP1.ubx_key_id, CFG_TP_PERIOD_TP1},
  {CFG_TP_PERIOD_LOCK_TP1.ubx_key_id, CFG_TP_PERIOD_LOCK_TP1},
  {CFG_TP_LEN_TP1.ubx_key_id, CFG_TP_LEN_TP1},
  {CFG_TP_LEN_LOCK_TP1.ubx_key_id, CFG_TP_LEN_LOCK_TP1},
  {CFG_TP_USER_DELAY_TP1.ubx_key_id, CFG_TP_USER_DELAY_TP1},
  {CFG_TP_TIMEGRID_TP1.ubx_key_id, CFG_TP_TIMEGRID_TP1},
  {CFG_TP_POL_TP1.ubx_key_id, CFG_TP_POL_TP1},
};
